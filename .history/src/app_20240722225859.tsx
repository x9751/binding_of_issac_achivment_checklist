...
export function App() {
  ...
  function saveAchievements() {
    ...
    localStorage.setItem("incompleteAchievements", JSON.stringify(incompleteAchievements));
    local
  }

  function loadAchievements() {
    const completedAchievements = JSON.parse(localStorage.getItem("completedAchievements") || "[]");
    const incompleteAchievements = JSON.parse(localStorage.getItem("incompleteAchievements") || "[]");
    const incompleteOpen = JSON.parse(localStorage.getItem("incompleteOpen") || "true");
    const completedOpen = JSON.parse(localStorage.getItem("completedOpen") || "true");

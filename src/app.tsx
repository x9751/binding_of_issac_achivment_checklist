...
export function App() {
	...
	const handleIncomplete = (achievement: Achievement) => {
		setIncompleteAchievements([...incompleteAchievements, achievement]);
		setCompletedAchievements(
			completedAchievements.filter((a) => a !== achievement)
		);
	};
	...
	return (
		<main className="bg-slate-900 text-white min-h-screen flex flex-col bg-[url('/background2.webp')] bg-fixed bg-center bg-contain bg-no-repeat">
			<div className="container mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="flex flex-col gap-4 mt-4 max-w-[600px] mx-auto">
					...
					{incompleteOpen && incompleteAchievements.length === 0 && (
						<p className="text-center">No achievements incomplete</p>
					)}
				</div>
				<div className="flex items-center justify-between mt-4 max-w-[600px] mx-auto ">
				...
				<div className="flex flex-col gap-4 mt-4 max-w-[600px] mx-auto ">
					...
					{completedOpen && completedAchievements.length === 0 && (
						<p className="text-center">No achievements completed</p>
					)}
				</div>
			</div>
		</main>
